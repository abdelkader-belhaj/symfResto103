            ...
            <div class=\"container position-relative d-flex align-items-center justify-content-between\">
                ...
                <nav id=\"navmenu\" class=\"navmenu\">
                    <ul>
                        ...
                        <li><a href=\"#book-a-table\" class=\"cta-btn\">Réserver une table</a></li>
                        
   ";
        // line 59
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 59, $this->source); })()), "session", [], "any", false, false, false, 59), "get", ["user"], "method", false, false, false, 59)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 60
            yield "    <!-- Utilisateur connecté -->
    <li class=\"nav-auth-section\">
        <div class=\"dropdown\">
            <button class=\"btn btn-auth dropdown-toggle d-flex align-items-center\" type=\"button\" id=\"userDropdown\" data-bs-toggle=\"dropdown\" aria-expanded=\"false\">
                <i class=\"bi bi-person-circle me-2\"></i>
                <span>nom : ";
            // line 65
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 65, $this->source); })()), "session", [], "any", false, false, false, 65), "get", ["user"], "method", false, false, false, 65), "nomComplete", [], "any", false, false, false, 65), "html", null, true);
            yield "</span>
            </button>
            <ul class=\"dropdown-menu dropdown-menu-end auth-dropdown\" aria-labelledby=\"userDropdown\">
                <li class=\"dropdown-header\">
                    <div class=\"d-flex align-items-center\">
                        ...
                        <div>
                            <h6 class=\"mb-0\">";
            // line 72
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 72, $this->source); })()), "session", [], "any", false, false, false, 72), "get", ["user"], "method", false, false, false, 72), "nomComplete", [], "any", false, false, false, 72), "html", null, true);
            yield "</h6>
                            <small class=\"text-muted\">";
            // line 73
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 73, $this->source); })()), "session", [], "any", false, false, false, 73), "get", ["user"], "method", false, false, false, 73), "email", [], "any", false, false, false, 73), "html", null, true);
            yield "</small>
                        </div>
                    </div>
                </li>
...
";
    ...
    <li class=\"nav-auth-section\">
        <div class=\"dropdown\">
            <button class=\"btn btn-auth dropdown-toggle d-flex align-items-center\" type=\"button\" id=\"authDropdown\" data-bs-toggle=\"dropdown\" aria-expanded=\"false\">
                <i class=\"bi bi-person me-2\"></i>
                <span>Mon Compte</span>
            </button>
            <ul class=\"dropdown-menu dropdown-menu-end auth-dropdown\" aria-labelledby=\"authDropdown\">
                <li class=\"dropdown-header\">
                    <h6 class=\"mb-0\">Accéder à votre compte</h6>
                </li>
                <li><hr class=\"dropdown-divider\"></li>
                <li>
                    <a class=\"dropdown-item\" href=\"";
...
";
    ...
    <style>
    /* Styles pour section auth unifiée */
    .nav-auth-section,
    .nav-user-section {
        margin-left: 20px;
        display: flex;
    ...
    /* Bouton d'authentification unifié */
    .btn-auth {
    ...
    .auth-dropdown .dropdown-header h6 {
        margin-bottom: 0;
        font-weight: 600;
        color: #2c3e50;
        font-size: 14px;
    ...
    @media (max-width: 991px) {
        ...
        .btn-auth span, .profile-name {
            display: none;
        }
        
        .btn-auth i, .btn-profile i {
            margin: 0;
        }
    }

    @media (max-width: 768px) {
        /* Cache les boutons auth sur mobile - ils seront dans le menu mobile */
        .nav-auth-section,
        .nav-user-section {
            display: none;
        }
      ...
      <div id=\"hero-carousel\" class=\"carousel slide carousel-fade\" data-bs-ride=\"carousel\" data-bs-interval=\"5000\">
        ...
        yield "\" alt=\"\">
          <div class=\"carousel-container\">
            ...
            <div>
              <a href=\"#menu\" class=\"btn-get-started\">Notre menu</a>
              <a href=\"#book-a-table\" class=\"btn-get-started\">À table !</a>
            </div>
          </div>
...
<div class=\"mb-5\">
  <iframe style=\"width: 100%; height: 400px;\" src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5624.499798015644!2d10.857646262990746!3d36.57623285400199!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1302bbbb1dd2ee7b%3A0x72079df2784587b4!2sAgil%20Korba!5e0!3m2!1sfr!2stn!4v1752772144110!5m2!1sfr!2stn\"  frameborder=\"0\" allowfullscreen=\"\"></iframe>
</div><!-- End Google Maps -->
        ...
        <div class=\"row gy-5 gx-lg-5\">
          ...
          <div class=\"col-lg-4\">
            ...
            <div class=\"info\">
              ...
              <p>N'hésitez pas à nous contacter pour toute question ou demande. Nous sommes à votre écoute pour vous aider.</p>

              <div class=\"info-item d-flex\">
                <i class=\"bi bi-geo-alt flex-shrink-0\"></i>
                <div>
                  <h4>Localisation:</h4>
                  <p>Nabeul,Korba  8070 </p>
                </div>
              </div><!-- End Info Item -->
              ...
              <div class=\"info-item d-flex\">
                ...
                <div>
                  <h4>Email:</h4>
                  <p>abdelkader.belhaj@esprit.tn</p>
                </div>
              </div><!-- End Info Item -->
...
<script>
function checkAuthBeforeSubmit(targetUrl, formId = null) {
    // Vérifie si l'utilisateur est connecté
    ";
        // line 670
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 670, $this->source); })()), "session", [], "any", false, false, false, 670), "get", ["user"], "method", false, false, false, 670)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 671
            yield "        // Si connecté, soumet le formulaire ou redirige
        if (formId) {
    ...
    ";
            ...
            // line 678
            yield "        // Si non connecté, affiche l'alerte
        showLoginAlert(targetUrl);
    ";
        }
        // line 681
        yield "}

function showLoginAlert(targetUrl) {
    ...
    // Création d'un élément script pour stocker la targetUrl
    const urlScript = document.createElement('script');
    urlScript.textContent = `var loginRedirectUrl = '\${targetUrl}';`;
    
    alertBox.innerHTML = `
        <div style=\"background: white; padding: 30px; border-radius: 10px; text-align: center; max-width: 400px;\">
            <h4 style=\"color: #ff6b35; margin-bottom: 20px;\">Connexion requise</h4>
            <p style=\"margin-bottom: 25px;\">Vous devez vous connecter avant de pouvoir effectuer cette action.</p>
            <div>
                <button id=\"loginAlertBtn\" 
    ...
    document.getElementById('loginAlertBtn').addEventListener('click', function() {
        window.location.href = '";
        // line 724
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_login");
        yield "?redirect=' + encodeURIComponent(loginRedirectUrl);
    });
    ...
    <div class=\"row gy-3\">
      ...
      <div class=\"col-lg-3 col-md-6 d-flex\">
        ...
        <div>
          ...
          <p> 
            <strong>Ouvert tous </strong> <span>les jours</span><br>
            <span>de 07h00 à </span> <span>02h00</span>
          </p>
        </div>
      </div>
  ...
  <div class=\"container copyright text-center mt-4\">
    <div class=\"credits\">
      ...
      <!-- Achetez la version pro avec formulaire de contact PHP/AJAX fonctionnel : [buy-url] -->
        <p>Développé par  - <a href=\"mailto:ton.email@example.com\">abdelkader.belhaj@esprit.tn</a></p>
...
";
    ...
    {
        return array (  1195 => 737,  1185 => 736,  1175 => 496,  1165 => 495,  1156 => 492,  1146 => 491,  1136 => 487,  1126 => 486,  1117 => 483,  1107 => 482,  1098 => 479,  1088 => 478,  1078 => 474,  1068 => 473,  1060 => 30,  1058 => 29,  1048 => 28,  1031 => 27,  1016 => 839,  1010 => 836,  1006 => 835,  1002 => 834,  998 => 833,  994 => 832,  990 => 831,  986 => 830,  894 => 740,  892 => 736,  877 => 724,  832 => 681,  827 => 678,  818 => 671,  816 => 670,  734 => 591,  715 => 575,  696 => 559,  677 => 543,  658 => 527,  631 => 503,  625 => 499,  623 => 495,  620 => 494,  618 => 491,  615 => 490,  613 => 486,  610 => 485,  608 => 482,  605 => 481,  603 => 478,  600 => 477,  598 => 473,  526 => 404,  491 => 372,  476 => 360,  461 => 348,  232 => 121,  221 => 113,  213 => 108,  198 => 95,  186 => 86,  183 => 85,  175 => 79,  173 => 78,  165 => 73,  161 => 72,  151 => 65,  144 => 60,  142 => 59,  112 => 31,  110 => 28,  106 => 27,  101 => 25,  97 => 24,  93 => 23,  89 => 22,  85 => 21,  81 => 20,  70 => 12,  66 => 11,  54 => 1,);
    }
   ...
   {% if app.session.get('user') %}
    ...
    <li class=\"nav-auth-section\">
        <div class=\"dropdown\">
            <button class=\"btn btn-auth dropdown-toggle d-flex align-items-center\" type=\"button\" id=\"userDropdown\" data-bs-toggle=\"dropdown\" aria-expanded=\"false\">
                <i class=\"bi bi-person-circle me-2\"></i>
                <span>nom : {{ app.session.get('user').nomComplete }}</span>
            </button>
            <ul class=\"dropdown-menu dropdown-menu-end auth-dropdown\" aria-labelledby=\"userDropdown\">
                <li class=\"dropdown-header\">
                    <div class=\"d-flex align-items-center\">
                        <i class=\"bi bi-person-badge me-2\"></i>
                        <div>
                            <h6 class=\"mb-0\">{{ app.session.get('user').nomComplete }}</h6>
                            <small class=\"text-muted\">{{ app.session.get('user').email }}</small>
                        </div>
                    </div>
                </li>
                <li><hr class=\"dropdown-divider\"></li>
                {% if app.session.get('user').type == 'client' %}
                    <li>
                        <a class=\"dropdown-item\" href=\"#\">
                            <i class=\"bi bi-person me-2\"></i> Mon Profil
                        </a>
...
function checkAuthBeforeSubmit(targetUrl, formId = null) {
    // Vérifie si l'utilisateur est connecté
    {% if app.session.get('user') %}
        // Si connecté, soumet le formulaire ou redirige
        if (formId) {
            document.getElementById(formId).submit();
        } else {
            window.location.href = targetUrl;
    ...
    {% else %}
        // Si non connecté, affiche l'alerte
        showLoginAlert(targetUrl);
    {% endif %}
}
...
function showLoginAlert(targetUrl) {
    ...
    // Gestion des événements avec addEventListener
    document.getElementById('loginAlertBtn').addEventListener('click', function() {
        window.location.href = '{{ path('app_login') }}?redirect=' + encodeURIComponent(loginRedirectUrl);
    });
...
</html>", "base.html.twig", "C:\\Users\\21658\\Desktop\\1erCycleStage\\3A1Cycle - Copie (16) - Copie\\restorationSymf\\restorationSymf\\templates\\base.html.twig");
    }
}
